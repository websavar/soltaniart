...
const works = [
  {
    ...
    concept_en: 'Infinity began as a meditation on the inward motion of devotion. The composition orbits a hidden centre; warm earth tones and a thin glaze of cadmium gold pull the eye toward a horizon that exists only inside the canvas. The work was painted in twelve translucent layers over four months, each layer left to cure before the next was applied.',
    concept_de: 'Unendlichkeit entstand als Meditation über die nach innen gerichtete Bewegung der Hingabe. Die Komposition kreist um ein verborgenes Zentrum; warme Erdtöne und eine dünne Lasur aus Kadmiumgold lenken den Blick auf einen Horizont, der nur innerhalb der Leinwand existiert. Das Werk wurde in zwölf transluzenten Schichten über vier Monate gemalt, wobei jede Schicht vor dem Auftragen der nächsten aushärten musste.'
  },
  {
  ...
  },
  {
    ...
    media: [{ type: 'image', src: 'images/reproduction/Van_Gogh-Starry_Night.jpg.jpg', alt: 'The Starry Night reproduction' }],
